#!/usr/bin/env python3
"""Scrape, rephrase, and save today's Kumbam raasi palan."""
...
KUMBAM_INDEX = 10
KUMBAM_TA = "கும்பம்"
DEFAULT_URL = "https://www.astrosage.com/tamil/rasi-palan/kumbam-rasi-palan.asp"


def _arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Sync today's AstroSage Kumbam horoscope into பொதுப் பலன்."
    )
...
def main() -> None:
    ...
    if horoscope.sign_ta != KUMBAM_TA:
        raise RuntimeError(
            f"Expected {KUMBAM_TA}, but source page contains {horoscope.sign_ta}"
        )
