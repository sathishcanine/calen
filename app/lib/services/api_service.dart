...
class ApiService {
  ...
  Future<HomeSummary> fetchHome({
    ...
    final res = await _client.get(
      _uri('/home', {'city_id': cityId, 'date': dateStr}),
    );
  ...
  Future<DailyCalendar> fetchDay({
    ...
    final res = await _client.get(
      _uri('/calendar/day', {'city_id': cityId, 'date': dateStr}),
    );
  ...
  Future<List<DailyCalendar>> fetchDailyBundle({
    ...
    return items
        .map((e) => DailyCalendar.fromJson(e as Map<String, dynamic>))
        .toList();
  }
  ...
  Future<HoraWeek> fetchHoraWeek({
    ...
    final dateStr = DateFormat('yyyy-MM-dd').format(date);
    final res = await _client.get(
      _uri('/spiritual/hora-week', {'city_id': cityId, 'date': dateStr}),
    );
  ...
  Future<GowriWeek> fetchGowriWeek({
    ...
    final dateStr = DateFormat('yyyy-MM-dd').format(date);
    final res = await _client.get(
      _uri('/spiritual/gowri-week', {'city_id': cityId, 'date': dateStr}),
    );
    if (res.statusCode != 200)
      throw Exception('Gowri week failed: ${res.body}');
  ...
  Future<InauspiciousWeek> fetchInauspiciousWeek({
    ...
    final dateStr = DateFormat('yyyy-MM-dd').format(date);
    final res = await _client.get(
      _uri('/spiritual/inauspicious-week', {
        'city_id': cityId,
        'date': dateStr,
      }),
    );
    if (res.statusCode != 200)
      throw Exception('Inauspicious week failed: ${res.body}');
    return InauspiciousWeek.fromJson(
  ...
  Future<List<VastuArticle>> fetchVastuArticles() async {
    ...
    if (res.statusCode != 200)
      throw Exception('Vastu articles failed: ${res.body}');
    final list = jsonDecode(res.body) as List<dynamic>;
    return list
        .map((e) => VastuArticle.fromJson(e as Map<String, dynamic>))
        .toList();
  }
  ...
  Future<List<int>> fetchVastuYears() async {
    ...
    if (res.statusCode != 200)
      throw Exception('Vastu years failed: ${res.body}');
    final list = jsonDecode(res.body) as List<dynamic>;
  ...
  Future<VastuDays> fetchVastuDays({
    ...
    final res = await _client.get(
      _uri('/spiritual/vastu/days', {
        'city_id': cityId,
        'year': year.toString(),
      }),
    );
    if (res.statusCode != 200)
      throw Exception('Vastu days failed: ${res.body}');
  ...
  Future<List<PanchaPakshiArticle>> fetchPanchaPakshiArticles() async {
    ...
    if (res.statusCode != 200)
      throw Exception('Pancha Pakshi articles failed: ${res.body}');
    final list = jsonDecode(res.body) as List<dynamic>;
    return list
        .map((e) => PanchaPakshiArticle.fromJson(e as Map<String, dynamic>))
        .toList();
  }

  Future<PanchaPakshiArticleDetail> fetchPanchaPakshiArticle(int id) async {
    final res = await _client.get(
      _uri('/spiritual/pancha-pakshi/articles/$id', {
        'city_id': ApiConfig.defaultCityId,
      }),
    );
    if (res.statusCode != 200)
      throw Exception('Pancha Pakshi article failed: ${res.body}');
    return PanchaPakshiArticleDetail.fromJson(
      jsonDecode(res.body) as Map<String, dynamic>,
    );
  }
  ...
  Future<List<PanchaPakshiNakshatra>> fetchPanchaPakshiNakshatras() async {
    ...
    if (res.statusCode != 200)
      throw Exception('Nakshatras failed: ${res.body}');
    final list = jsonDecode(res.body) as List<dynamic>;
    return list
        .map((e) => PanchaPakshiNakshatra.fromJson(e as Map<String, dynamic>))
        .toList();
  }

  Future<List<PanchaPakshiPakshaOption>>
  fetchPanchaPakshiPakshaOptions() async {
    final res = await _client.get(
      _uri('/spiritual/pancha-pakshi/paksha-options'),
    );
    if (res.statusCode != 200)
      throw Exception('Paksha options failed: ${res.body}');
    final list = jsonDecode(res.body) as List<dynamic>;
    return list
        .map(
          (e) => PanchaPakshiPakshaOption.fromJson(e as Map<String, dynamic>),
        )
        .toList();
  }
  ...
  Future<List<int>> fetchPanchaPakshiYears() async {
    ...
    if (res.statusCode != 200)
      throw Exception('Pancha Pakshi years failed: ${res.body}');
    final list = jsonDecode(res.body) as List<dynamic>;
    return list.map((e) => e as int).toList();
  }
  ...
  Future<PanchaPakshiResult> fetchPanchaPakshiCalculate({
    ...
    final dateStr = DateFormat('yyyy-MM-dd').format(date);
    final res = await _client.get(
      _uri('/spiritual/pancha-pakshi/calculate', {
        'city_id': cityId,
    ...
    if (res.statusCode != 200)
      throw Exception('Pancha Pakshi calculate failed: ${res.body}');
    return PanchaPakshiResult.fromJson(
      jsonDecode(res.body) as Map<String, dynamic>,
    );
  }
  ...
  Future<List<JyotishNakshatra>> fetchJyotishNakshatras() async {
    ...
    final list = jsonDecode(res.body) as List<dynamic>;
    return list
        .map((e) => JyotishNakshatra.fromJson(e as Map<String, dynamic>))
        .toList();
  }
  ...
  Future<List<JyotishRashi>> fetchJyotishRashis() async {
    ...
    final list = jsonDecode(res.body) as List<dynamic>;
    return list
        .map((e) => JyotishRashi.fromJson(e as Map<String, dynamic>))
        .toList();
  }
  ...
  Future<NazhigaiResult> fetchNazhigaiConvert({
    ...
    final dateStr = DateFormat('yyyy-MM-dd').format(date);
    final res = await _client.get(
      _uri('/spiritual/jyotish/nazhigai-convert', {
        'city_id': cityId,
        'date': dateStr,
        'hour': hour.toString(),
    ...
    if (res.statusCode != 200)
      throw Exception('Nazhigai convert failed: ${res.body}');
    return NazhigaiResult.fromJson(
      jsonDecode(res.body) as Map<String, dynamic>,
    );
  }
  ...
  Future<ChandrashtamamResult> fetchChandrashtamam({
    ...
    final dateStr = DateFormat('yyyy-MM-dd').format(date);
    final res = await _client.get(
      _uri('/spiritual/jyotish/chandrashtamam', {
        'city_id': cityId,
    ...
    if (res.statusCode != 200)
      throw Exception('Chandrashtamam failed: ${res.body}');
    return ChandrashtamamResult.fromJson(
      jsonDecode(res.body) as Map<String, dynamic>,
    );
  }
  ...
  Future<NumerologyResult> fetchNumerology({
    ...
    final dateStr = DateFormat('yyyy-MM-dd').format(date);
    final res = await _client.get(
      _uri('/spiritual/jyotish/numerology', {
        'city_id': cityId,
        'name': name,
        'date': dateStr,
      }),
    ...
    if (res.statusCode != 200)
      throw Exception('Numerology failed: ${res.body}');
    return NumerologyResult.fromJson(
      jsonDecode(res.body) as Map<String, dynamic>,
    );
  }
  ...
  Future<MarriagePoruthamResult> fetchMarriagePorutham({
    ...
    if (person1Nakshatra != null)
      query['person1_nakshatra'] = person1Nakshatra.toString();
    if (person2Nakshatra != null)
      query['person2_nakshatra'] = person2Nakshatra.toString();
    final res = await _client.get(
      _uri('/spiritual/jyotish/marriage-porutham', query),
    );
    if (res.statusCode != 200)
      throw Exception('Marriage porutham failed: ${res.body}');
    return MarriagePoruthamResult.fromJson(
      jsonDecode(res.body) as Map<String, dynamic>,
    );
  }
  ...
  Future<TarabalamResult> fetchTarabalam({
    ...
    final dateStr = DateFormat('yyyy-MM-dd').format(date);
    final res = await _client.get(
      _uri('/spiritual/jyotish/tarabalam', {
        'city_id': cityId,
    ...
    return TarabalamResult.fromJson(
      jsonDecode(res.body) as Map<String, dynamic>,
    );
  }
  ...
  Future<List<PalangalCategory>> fetchPalangalCategories() async {
    ...
    if (res.statusCode != 200)
      throw Exception('Palangal categories failed: ${res.body}');
    final list = jsonDecode(res.body) as List<dynamic>;
    return list
        .map((e) => PalangalCategory.fromJson(e as Map<String, dynamic>))
        .toList();
  }

  Future<List<PalangalArticle>> fetchPalangalArticles(String categoryId) async {
    final res = await _client.get(
      _uri('/spiritual/palangal/categories/$categoryId/articles'),
    );
    if (res.statusCode != 200)
      throw Exception('Palangal articles failed: ${res.body}');
    final list = jsonDecode(res.body) as List<dynamic>;
    return list
        .map((e) => PalangalArticle.fromJson(e as Map<String, dynamic>))
        .toList();
  }

  Future<PalangalArticleDetail> fetchPalangalArticle(
    String categoryId,
    int articleId,
  ) async {
    final res = await _client.get(
    ...
    if (res.statusCode != 200)
      throw Exception('Palangal article failed: ${res.body}');
    return PalangalArticleDetail.fromJson(
      jsonDecode(res.body) as Map<String, dynamic>,
    );
  }
  ...
  Future<List<StatusStory>> fetchStatusStories({int limit = 10}) async {
    final res = await _client.get(
      _uri('/spiritual/status-stories', {'limit': limit.toString()}),
    );
    if (res.statusCode != 200)
      throw Exception('Status stories failed: ${res.body}');
    final list = jsonDecode(res.body) as List<dynamic>;
    return list
        .map((e) => StatusStory.fromJson(e as Map<String, dynamic>))
        .toList();
  }
  ...
  Future<List<BookCategory>> fetchLibraryCategories() async {
    ...
    if (res.statusCode != 200)
      throw Exception('Library categories failed: ${res.body}');
    final list = jsonDecode(res.body) as List<dynamic>;
    return list
  ...
  Future<List<LibraryBook>> fetchLibraryBooks(String categoryId) async {
    final res = await _client.get(
      _uri('/library/books', {'category_id': categoryId}),
    );
    if (res.statusCode != 200)
      throw Exception('Library books failed: ${res.body}');
    final list = jsonDecode(res.body) as List<dynamic>;
    return list
  ...
  Future<List<MetalRateCity>> fetchMetalRateCities() async {
    ...
    if (res.statusCode != 200)
      throw Exception('Metal rate cities failed: ${res.body}');
    final list = jsonDecode(res.body) as List<dynamic>;
    return list
        .map((e) => MetalRateCity.fromJson(e as Map<String, dynamic>))
        .toList();
  }
  ...
  Future<MetalRates> fetchMetalRates({
    ...
    final res = await _client.get(
      _uri('/spiritual/metal-rates', {'city_id': cityId, 'period': period}),
    );
    if (res.statusCode != 200)
      throw Exception('Metal rates failed: ${res.body}');
  ...
  Future<List<Temple>> fetchTemples({int limit = 30, int offset = 0}) async {
    final res = await _client
        .get(
          _uri('/spiritual/temples', {'limit': '$limit', 'offset': '$offset'}),
        )
  ...
  Future<Temple> fetchTempleBySlug(String slug) async {
    final res = await _client
        .get(_uri('/spiritual/temples/$slug'))
        .timeout(const Duration(seconds: 12));
